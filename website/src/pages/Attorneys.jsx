  ...
  const attorneys = [
    {
      ...
      specialization: 'Civil, Property & Real Estate, Family Law, Estate Planning & Notary Practice',
      ...
      bio: 'With over 25 years of distinguished courtroom and documentation experience, Smt. V. Bhagya Lakshmi is the founding advocate of VBL Law Chambers. She is an authorized Advocate & Notary based in Kavali, SPSR Nellore District, recognized for meticulous title scrutiny, testamentary succession planning, development agreement vetting, and civil litigation.',
    ...
    },
    {
      ...
      specialization: 'Development Agreements & Commercial Contracts',
      ...
      bio: 'Michael is a seasoned legal counsel specializing in joint development agreements (JDA), builder-landowner contracts, and corporate structuring. His strategic approach protects client equity and ensures statutory compliance.',
    ...
    },
    {
      ...
      specialization: 'Legal Clearance of Property Documents & Title Scrutiny',
      image: 'https://images.unsplash.com/photo-1758518731462-d091b0b4ed0d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmZW1hbGUlMjBsYXd5ZXIlMjBwcm9mZXNzaW9uYWx8ZW58MXx8fHwxNzcyMDIyMTUyfDA&ixlib=rb-4.1.0&q=80&w=1080',
      bio: 'Jennifer brings in-depth expertise in 30-year property title verification, encumbrance analysis, revenue record scrutiny, and comprehensive legal clearance reports for buyers, developers, and financial institutions.',
    ...
    },
    {
      ...
      title: 'Associate Partner',
      credentials: 'B.A., LL.B.',
      specialization: 'General Power of Attorney (GPA) & Terms and Services',
      image: 'https://images.unsplash.com/photo-1658249682512-1bb162538ba9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtYWxlJTIwYXR0b3JuZXklMjBidXNpbmVzcyUyMHN1aXR8ZW58MXx8fHwxNzcyMDIyMTUyfDA&ixlib=rb-4.1.0&q=80&w=1080',
      bio: 'Robert focuses on drafting General and Special Power of Attorney deeds, terms of service agreements, master service contracts, and commercial documentation tailored to statutory compliance.',
